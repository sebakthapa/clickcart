...
const Landing = () => {
    ...
    return (
        <section style={{ background: "url('/landingBG.png')", backgroundSize: "cover" }} className="w-full bg-red-500 Landing-section h-[625px] lg:h-[600px] md:h-[550px] sm:h-[400px] flex items-center lg:items-center justify-center mt-[100px] bg-cover bg-no-repeat">
